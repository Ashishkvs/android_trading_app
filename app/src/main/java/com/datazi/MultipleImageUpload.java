...
public class MultipleImageUpload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSelectBtn =  findViewById(R.id.uploadButton);
        mUploadList = (RecyclerView) findViewById(R.id.imageList);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK){
            ...
            if(data.getClipData() != null){
                ...
                Toast.makeText(MultipleImageUpload.this, "Selected Single File", Toast.LENGTH_SHORT).show();
